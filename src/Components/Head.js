  ...
  return (
    <div className="grid grid-flow-col p-2 fixed left-2 right-0 top-0 z-50 bg-white">
      <div className="flex col-span-1 items-center">
        ...
        <img
          className="h-5 mx-4 ml-4 cursor-pointer"
          src={
      ...
      <div className="col-span-10 flex items-center ml-20">
        <input
        ...
        <button className="border border-gray-400 p-2 rounded-r-full">
          <img
            className="h-6 px-3"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKeMNg5YvA8z5vvx7PXC2qZNTc2C41lBhNv70ngtQ&s"
            alt="search img"
          />
        </button>
      </div>
